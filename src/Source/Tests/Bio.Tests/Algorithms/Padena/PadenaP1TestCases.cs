...
namespace Bio.Tests.Algorithms.Padena
{
    ...
    internal class PadenaP1Test : ParallelDeNovoAssembler
    {
        ...
        readonly Utility utilityObj = new Utility(Path.Combine(TestContext.CurrentContext.TestDirectory, "TestUtils", "PadenaTestData", "PadenaTestsConfig.xml"));
        ...
        internal void ValidatePadenaBuildKmers(string nodeName, bool isSmallSize)
        {
            ...
            string filePath = Path.Combine(TestContext.CurrentContext.TestDirectory, utilityObj.xmlUtil.GetTextValue(nodeName, Constants.FilePathNode));
...
parser.Open(filePath);
        ...
        {
            string kmerOutputFile = Path.Combine(TestContext.CurrentContext.TestDirectory, utilityObj.xmlUtil.GetTextValue(nodeName,
...
parser.Open(filePath);
        ...
        {
            string nodesSequence = Path.Combine(TestContext.CurrentContext.TestDirectory, utilityObj.xmlUtil.GetTextValue(nodeName,
              Constants.NodesSequenceNode));
            string nodesLeftEdges = Path.Combine(TestContext.CurrentContext.TestDirectory, utilityObj.xmlUtil.GetTextValue(nodeName,
              Constants.NodesLeftEdgesCountNode));
            string nodesRightEdges = Path.Combine(TestContext.CurrentContext.TestDirectory, utilityObj.xmlUtil.GetTextValue(nodeName,
        ...
        {
            string filePath = Path.Combine(TestContext.CurrentContext.TestDirectory, utilityObj.xmlUtil.GetTextValue(nodeName,
...
parser.Open(filePath);
        ...
        internal void ValidateDe2thisBuildContigs(string nodeName, bool isChromosomeRC)
        {
            ...
            string kmerLength = utilityObj.xmlUtil.GetTextValue(nodeName,
              Constants.KmerLengthNode);
            string expectedContigsString = Path.Combine(TestContext.CurrentContext.TestDirectory, utilityObj.xmlUtil.GetTextValue(nodeName,
