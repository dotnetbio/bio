...
namespace Bio.IO.AppliedBiosystems
{
    ...
    /// </summary>
    [Serializable]
    public sealed class Ab1DirectoryEntry : ISerializable
    {
        ...
        private Ab1DirectoryEntry(SerializationInfo info, StreamingContext context)
        {
            if (info == null) throw new ArgumentNullException("info");
            Initialize((byte[])info.GetValue(Key, typeof(byte[])));
        }
