...
namespace NucmerUtil
{
    ...
    public class Program
    {
        ...
        private static void Alignment(string[] args)
        {
            ...
            parser.Parameter(ArgumentType.Optional, "MumReference", ArgumentValueType.Bool, "r", 
            ...
            parser.Parameter(ArgumentType.Optional, "BreakLength", ArgumentValueType.Int, "b", 
            ...
            parser.Parameter(ArgumentType.Optional, "DiagFactor", ArgumentValueType.Int, "d",
                "Maximum diagonal difference factor for clustering, i.e. diagonal difference / match separation (default 0.12).");
            parser.Parameter(ArgumentType.Optional, "ForwardAndReverse", ArgumentValueType.Bool, "f", 
                "Align only the forward and reverse strands of each sequence.");
            ...
            parser.Parameter(ArgumentType.Optional, "Reverse", ArgumentValueType.Bool, "e", 
                "Align only the reverse strand of the query sequence to the forward strand of the reference.");
            parser.Parameter(ArgumentType.Optional, "NotExtend", ArgumentValueType.Bool, "n",
                "Toggle the outward extension of alignments from their anchoring clusters." +
