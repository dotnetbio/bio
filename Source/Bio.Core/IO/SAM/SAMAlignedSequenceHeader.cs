...
namespace Bio.IO.SAM
{
    ...
    public class SAMAlignedSequenceHeader
    {
        ...
        /// </summary>
        private static readonly char[] QNameIllegalCharacters =  {' ','\t','\n','\r'};
        ...
        /// </summary>
        private static readonly Regex RNameRegxExpr = new Regex(RNameRegxExprPattern);

        /// <summary>
        /// Regular Expression object for CIGAR.
        /// </summary>
        private static readonly Regex CIGARRegxExpr = new Regex(CIGARRegxExprPattern);

        /// <summary>
        /// Regular Expression object for MRNM.
        /// </summary>
        private static readonly Regex MRNMRegxExpr = new Regex(MRNMRegxExprPattern);
